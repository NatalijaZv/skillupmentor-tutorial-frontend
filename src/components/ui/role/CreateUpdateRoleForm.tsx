// import { CreateUpdateRoleFields, useCreateUpdateRoleForm } from 'hooks/useCreateUpdateRole'
...
//     const { handleSubmit, errors, control, register } = useCreateUpdateRoleForm({ defaultValues })
...
//                         defaultChecked: false
//                     })
//                 }) //Permission data we are getting from the backend
//             }
...
//                     ))}
//                     {errors.permissions && (<div className='invalid-feedback text-danger'>
//                         {errors.permissions.message}
//                     </div>)}
//                 </div>
//                 <div className="d-flex justify-content-between align-items-center mb-2">
//                     <p className="mb-0"> Don{'\''} have account yet?</p>
...
//                         <Toast.Header>
//                             <strong className="me-auto text-danger"></strong>Error
//                         </Toast.Header>
...
} from 'hooks/useCreateUpdateRole'
import { FC, useEffect, useState } from 'react'
